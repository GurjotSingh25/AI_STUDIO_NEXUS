...
import { BriefcaseBusiness, Search, Play,Book, FileCode, Zap, TrendingUp, BookOpen, GitBranch, Users, Star, Filter } from "lucide-react"
      ...
      <div className="mb-8 overflow-x-auto">
        <div className="flex gap-3 pb-2">
          ...
          <button 
            ...
            className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold whitespace-nowrap flex items-center gap-2 shadow-lg transition-all"
          >
          ...
          <button className="px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition whitespace-nowrap flex items-center gap-2">
